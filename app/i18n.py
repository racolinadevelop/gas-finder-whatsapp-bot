TRANSLATIONS = {
    "en": {
       "choose_language": (
        ...
        "station_distance_estimated": "📍 Approx. distance: {distance:.2f} mi",
        "station_drive_eta": "⏱️ Estimated drive: {minutes} min",
        "station_route_unavailable": "📍 Driving distance unavailable",
    ...
    "es": {
        ...
        "station_distance_estimated": "📍 Distancia aproximada: {distance:.2f} mi",
        "station_drive_eta": "⏱️ Tiempo estimado: {minutes} min",
        "station_route_unavailable": "📍 Distancia por carretera no disponible",
